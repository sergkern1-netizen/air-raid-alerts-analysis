...
print("=" * 70)
print("ADVANCED ANALYTICS: Comparative Forecasting Analysis")
print("=" * 70)
...
# GitHub
github_path = Path.cwd() / 'data' / 'raw' / 'github_vadimkin.csv'
...
# Kaggle
kaggle_path = Path.cwd() / 'data' / 'raw' / 'kaggle_dimakyn.csv'
...
print(f"Combined dataset loaded: {len(df_raw):,} records")
...
try:
    ...
    plt.tight_layout()
    plot_path = Path('notebooks/plots/01_daily_timeline_advanced.png')
...
print(f"\nTest set size: {len(df_test)} days\n")
